...
| 904 | [水果成篮](滑动窗口/904.fruit-into-baskets.java) | Medium | 变长窗口+HashMap | ✅ |
...
| 1004 | [最大连续1的个数 III](1004.max-consecutive-ones-iii.java) | Medium | 变长窗口 | ✅ |
| 1658 | [将 x 减到 0 的最小操作数](1658.minimum-operations-to-reduce-x-to-zero.java) | Medium | 变长窗口（逆向思维） | ✅ |
| 1695 | [删除子数组的最大得分](滑动窗口/1695.maximum-erasure-value.java) | Medium | 变长窗口+HashSet | ✅ |
