...
map.merge(c, 1, Integer::sum);  // 推荐⭐ 更简洁
...
if (map.get(c) == 0) map.remove(c);  // 清理0值
```
...
| 定长窗口 | 1343. 大小为K且平均值大于等于阈值的子数组数目 | Medium | ✅ |
| 定长窗口 | 1456. 定长子串中元音的最大数目 | Medium | ✅ |
| 定长窗口 | 2090. 半径为k的子数组平均值 | Medium | ✅ |
| 定长窗口 | 2379. 得到K个黑块的最少涂色次数 | Easy | ✅ |
| 定长窗口+逆向 | 1423. 可获得的最大点数 | Medium | ✅ |
| 定长窗口+HashMap | 2461. 长度为K子数组中的最大和 | Medium | ✅ |
| 定长窗口+HashMap | 2841. 几乎唯一子数组的最大和 | Medium | ✅ |
| 变长-最长 | 3. 无重复字符的最长子串 | Medium | ✅ |
| 变长-最长 | 1208. 尽可能使字符串相等 | Medium | ✅ |
| 变长-最长 | 1493. 删掉一个元素以后全为1的最长子数组 | Medium | ✅ |
| 变长-最长+HashMap | 2024. 考试的最大困扰度 | Medium | ✅ |
| 变长-最长+HashMap | 3090. 每个字符最多出现两次的最长子字符串 | Easy | ✅ |
| 排序+滑动窗口 | 3634. 使数组平衡的最少移除数目 | Medium | ✅ |
| 定长窗口+单调队列 | 239. 滑动窗口最大值 | Hard | 🚧 |
| 变长-最长 | 1004. 最大连续1的个数 III | Medium | ✅ |
| 变长-最长（逆向） | 1658. 将 x 减到 0 的最小操作数 | Medium | ✅ |
